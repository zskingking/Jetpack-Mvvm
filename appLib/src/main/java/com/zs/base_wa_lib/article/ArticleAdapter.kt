...
import com.example.base_wa_library.databinding.ItemHomeArticleBinding
import com.example.base_wa_library.databinding.ItemProjectBinding
...
class ArticleAdapter(private val context: Context):ListAdapter<ArticleListBean,RecyclerView.ViewHolder>(getArticleDiff()){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == AppLibConstants.ITEM_ARTICLE){
    ...
    override fun getItemViewType(position: Int): Int {
        return if (currentList[position].itemType == AppLibConstants.ITEM_ARTICLE){
            //普通类型
